...
$string['profile_category_odoo'] = 'Student data (Odoo)';
$string['profile_odoo_id'] = 'Odoo student ID';
$string['profile_year'] = 'Grade (year)';
$string['profile_standard'] = 'Class (standard)';
$string['profile_license_due'] = 'License due date';
$string['profile_license_status'] = 'License status';
$string['profile_license_active'] = 'Active';
$string['profile_license_expired'] = 'Expired';
$string['profile_license_other'] = 'Other';
$string['course_deleted_id'] = 'Course deleted (id {$a})';
$string['mapping_warning_no_manual_enrol'] = 'Warning: this course has no manual enrolment method. Students will not be enrolled until you add one.';
$string['when_student_not_in_odoo'] = 'When student is no longer in Odoo';
$string['when_student_not_in_odoo_help'] = 'If a Moodle user was previously synced as a student but no longer appears in the Odoo API (e.g. left school), this action is applied on the next sync run.';
$string['when_student_not_in_odoo_do_nothing'] = 'Do nothing (keep user and enrolments)';
$string['when_student_not_in_odoo_unenrol'] = 'Unenrol from all Odoo-mapped courses';
$string['when_student_not_in_odoo_suspend'] = 'Unenrol from Odoo-mapped courses and suspend user account';
