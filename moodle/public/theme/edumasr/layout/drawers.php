...
/**
 * Edumasr Academy drawers layout - own design with fixed sidebar.
 *
...
$bodyattributes = $OUTPUT->body_attributes(['edumasr-layout', 'uses-drawers']);
...
echo $OUTPUT->render_from_template('theme_edumasr/drawers', $templatecontext);
