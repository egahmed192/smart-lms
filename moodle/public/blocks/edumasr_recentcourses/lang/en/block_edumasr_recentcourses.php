...
$string['maxcourses_help'] = 'Maximum number of recently accessed courses to display (default: 10).';
$string['privacy:metadata'] = 'The Recently accessed courses block does not store any personal data.';
$string['edumasr_recentcourses:myaddinstance'] = 'Add a new recently accessed courses block to Dashboard';
