...
class __Mustache_6aac292d2c6cf740a793a819b54e7284 extends Mustache_Template
{
...
';
        if ($parent = $this->mustache->loadPartial('theme_boost/drawer')) {
            $context->pushBlockContext(array(
                ...
                'drawerheading' => array($this, 'blockB284415ba0c96087b9a5530a403f7c79'),
                'drawercontent' => array($this, 'block7bad5b303e0cb0a24e88341192f8b805'),
    ...
    private function section3efafdf2c607d8d41800792b0bc6a647(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionAb61d0528b12fe0244a4af5e806a9206(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section575b5ca716fe102a1058a48f68ca6794(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->sectionAb61d0528b12fe0244a4af5e806a9206($context, $indent, $value);
                $buffer .= $indent . '                </div>
';
                $context->pop();
            }
    ...
    private function sectionF4b139ae7bf5aeaac3420c77bf474a70(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->section575b5ca716fe102a1058a48f68ca6794($context, $indent, $value);
                $value = $context->find('haschildren');
                if (empty($value)) {
...
';
    ...
    public function blockB284415ba0c96087b9a5530a403f7c79($context)
    {
        $indent = $buffer = '';
        $buffer .= '        <a
';
...
';
        ...
        $buffer .= $this->section3efafdf2c607d8d41800792b0bc6a647($context, $indent, $value);
        $value = $context->findDot('output.should_display_navbar_logo');
        if (empty($value)) {
...
';
    ...
    public function block7bad5b303e0cb0a24e88341192f8b805($context)
    {
        $indent = $buffer = '';
        $buffer .= $indent . '        <div class="list-group">
';
        $value = $context->find('mobileprimarynav');
        $buffer .= $this->sectionF4b139ae7bf5aeaac3420c77bf474a70($context, $indent, $value);
        $buffer .= $indent . '        </div>
';
