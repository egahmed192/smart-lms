...
class __Mustache_0727cc2e3e5556bd725d2554301a88e0 extends Mustache_Template
{
...
';
        $buffer .= $indent . '    <div id="menusortby" role="tablist" class="dropdown-menu dropdown-menu-end list-group hidden" data-show-active-item>
';
        $buffer .= $indent . '        <a
';
