...
class __Mustache_e95febc77d3ecc6875e44f5908fe0778 extends Mustache_Template
{
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '    <div id="page" style="min-height: 100vh; padding: 0; margin: 0;">
';
        $buffer .= $indent . '        <div id="page-content" style="margin: 0; padding: 0;">
';
        $buffer .= $indent . '            <div id="region-main-box" style="margin: 0; padding: 0;">
';
        $buffer .= $indent . '                <div id="region-main" style="margin: 0; padding: 0;">
';
        $buffer .= $indent . '                    ';
