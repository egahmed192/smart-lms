...
class __Mustache_26c4810daa2d58130f469e2d89f16201 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section33b79dc3d0b61227990e961f683ac9ee($context, $indent, $value);
        $value = $context->find('haschildren');
        if (empty($value)) {
...
';
            ...
            $buffer .= $this->section1e4bc1c8865230b7c44512fa8397d995($context, $indent, $value);
            $value = $context->find('istablist');
            if (empty($value)) {
...
';
    ...
    private function section6185e5d82ae4d52d46ad44d43deb5c5c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section33b79dc3d0b61227990e961f683ac9ee(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section6185e5d82ae4d52d46ad44d43deb5c5c($context, $indent, $value);
                $buffer .= $indent . '        </div>
';
                $buffer .= $indent . '    </li>
';
    ...
    private function section3d9b538d72f81feb949c62c176db3726(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section1e4bc1c8865230b7c44512fa8397d995(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $value = $context->find('is_action_link');
                $buffer .= $this->section3d9b538d72f81feb949c62c176db3726($context, $indent, $value);
                $value = $context->find('is_action_link');
                if (empty($value)) {
