...
class __Mustache_cf80b611c2fdab81612dea8d57920b2e extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section30f871028e47e0467130ee130f178ef1($context, $indent, $value);
        $value = $context->find('logourl');
        if (empty($value)) {
...
';
        ...
        $buffer .= $this->sectionE02345c23abe5aaea07132d485c41863($context, $indent, $value);
        $value = $context->find('info');
        $buffer .= $this->sectionB6b44bfe37f8be1748cf8c9b43c738bf($context, $indent, $value);
        $value = $context->find('showloginform');
        $buffer .= $this->section7afb4828f1efb703127b3a14ef7f1eb5($context, $indent, $value);
        $value = $context->find('hasidentityproviders');
        $buffer .= $this->sectionEbc714d27e74c5e0b078bf9361c60049($context, $indent, $value);
...
';
        ...
        $buffer .= $this->section8867036e3e2026c8ea76cf957c16436c($context, $indent, $value);
...
';
    ...
    private function section30f871028e47e0467130ee130f178ef1(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionE02345c23abe5aaea07132d485c41863(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionB6b44bfe37f8be1748cf8c9b43c738bf(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionF4ef70c675561a135f2a205f20f80763(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section7afb4828f1efb703127b3a14ef7f1eb5(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->sectionF4ef70c675561a135f2a205f20f80763($context, $indent, $value);
...
';
    ...
    private function section5fa7c2726ff0491281fb57a83717448e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionEbc714d27e74c5e0b078bf9361c60049(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section5fa7c2726ff0491281fb57a83717448e($context, $indent, $value);
                $buffer .= $indent . '        </div>
';
                $context->pop();
            }
...
';
    ...
    private function section8867036e3e2026c8ea76cf957c16436c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
