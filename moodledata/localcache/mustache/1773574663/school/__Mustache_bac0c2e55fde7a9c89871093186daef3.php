...
class __Mustache_bac0c2e55fde7a9c89871093186daef3 extends Mustache_Template
{
...
';
        $buffer .= $indent . '    <div class="position-relative d-flex ftoggler align-items-center position-relative me-1">
';
        $value = $context->find('collapseable');
        $buffer .= $this->section4c0dc79dde4364c033f476f95cf31ab0($context, $indent, $value);
...
';
    ...
    private function section4c0dc79dde4364c033f476f95cf31ab0(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            <a data-bs-toggle="collapse"
               ...
               class="btn btn-icon me-3 icons-collapse-expand stretched-link fheader {{#collapsed}}collapsed{{/collapsed}}"
            >
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '            <a data-bs-toggle="collapse"
';
                $buffer .= $indent . '               href="#';
                $value = $this->resolveValue($context->find('id'), $context);
                $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
...
';
                ...
                $buffer .= 'container"
';
                $buffer .= $indent . '               class="btn btn-icon me-3 icons-collapse-expand stretched-link fheader ';
                $value = $context->find('collapsed');
